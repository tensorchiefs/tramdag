...
monotone normalizing flow, the statistician's *transformation model*. The
whole model is one triangular normalizing flow from
...
- `experiments/` holds the paper replications and their frozen data sets.
