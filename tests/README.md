...
| [`test_custom_terms.py`](test_custom_terms.py) | the two-class term contract: `Fn`, a `Term` plus `ShiftModule` subclass, a custom `regularizer`, and the refusals for an unknown or orphan term |
